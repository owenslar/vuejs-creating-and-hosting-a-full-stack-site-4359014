<template>
  <div v-if="product">
    ...
    <div class="product-details">
      ...
      <button class="grey-button" v-if="inCart && user">Item is already in your cart</button>
      <button @click="addToCart" class="add-to-cart" v-if="!inCart && user">Add to cart</button>
